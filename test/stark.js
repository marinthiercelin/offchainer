...
const fooStark = instantiateScript('./computation.air');
...
const assertions = [
    ...
    { register: 0, step: 31 , value: output }   // value at last step is 127
];
...
const result = fooStark.verify(assertions, proof, [[input]]);
